...
package com.iss.phonealarm.bean.uploadalarm.view;
...
public class CircleProgressBar extends View implements Runnable {
    ...
    private int mCpbStrokeWidth = 20;// default stroke width
...
//        drawProgressText(canvas);
    ...
    public void setProgress(int progress) {
        if (progress < MAX_PROGRESS) {
            ...
            this.mCurrentProgress = (int) MAX_PROGRESS;
        }
        if (!mCpbNeedAnim) {
            invalidateUi();
        }
