...
/**
 * 缓存调度器 工作描述： 缓存逻辑同样也采用责任链模式， 由缓存任务队列CacheQueue，缓存调度器CacheDispatcher，缓存器Cache组成
...
public class CacheDispatcher extends Thread {
     ...
     */
    public CacheDispatcher(BlockingQueue<Request<?>> cacheQueue, BlockingQueue<Request<?>> networkQueue, ICache cache,
            IDelivery delivery) {
