...
public class Response<T> {
    ...
    private Response(T result, Map<String, String> headers, ICache.Entry cacheEntry) {
        this.result = result;
     ...
     */
    public static <T> Response<T> success(T result, Map<String, String> headers, ICache.Entry cacheEntry) {
