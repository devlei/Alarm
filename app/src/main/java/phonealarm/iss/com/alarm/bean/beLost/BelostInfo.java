...
public class BelostInfo {
	...
	public String toString() {
		return "BelostInfo [beLost_id=" + beLost_id + ", beLost_name="
				+ beLost_name + ", beLost_sex=" + beLost_sex + ", beLost_age="
				+ beLost_age + ", beLost_site=" + beLost_site
				+ ", beLost_date=" + beLost_date + ", beLost_bithdate="
				+ beLost_bithdate + ", beLost_weigth=" + beLost_weigth
				+ ", beLost_hairstyle=" + beLost_hairstyle
				+ ", beLost_information=" + beLost_information
				+ ", beLost_telename=" + beLost_telename + ", beLost_telenum="
				+ beLost_telenum + ", beLost_pUrl=" + beLost_pUrl
