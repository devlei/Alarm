...
public class SuspectInfo {
	...
	public String toString() {
		return "SuspectInfo [suspect_id=" + suspect_id + ", suspect_name="
				+ suspect_name + ", suspect_birth=" + suspect_birth
				+ ", suspect_card=" + suspect_card + ", suspect_rank="
				+ suspect_rank + ", suspect_feature=" + suspect_feature
				+ ", suspect_case=" + suspect_case + ", suspect_award="
				+ suspect_award + ", suspect_fanzui=" + suspect_fanzui
				+ ", suspect_purl=" + suspect_purl + ", pursuit_time="
				+ pursuit_time + "]";
	}
