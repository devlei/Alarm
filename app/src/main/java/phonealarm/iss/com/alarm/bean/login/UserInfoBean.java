package phonealarm.iss.com.alarm.bean.login;
...
public class UserInfoBean {
	...
	public String toString() {
		return "UserInfoBean [userid=" + userid + ", password=" + password
				+ ", username=" + username + ", telephone=" + telephone
				+ ", starttime=" + starttime + ", startadress=" + startadress
				+ ", endtime=" + endtime + ", endadress=" + endadress
				+ ", imei=" + imei + ", device_type=" + device_type
				+ ", clientid=" + clientid + ", current_userid="
				+ current_userid + ", new_userid=" + new_userid + "]";
	}
