...
public class CarInfo {
	...
	public String toString() {
		return "CarInfo [car_id=" + car_id + ", car_num=" + car_num
				+ ", car_type=" + car_type + ", car_brand=" + car_brand
				+ ", car_color=" + car_color + ", car_info=" + car_info
				+ ", car_purl=" + car_purl + ", car_date=" + car_date
